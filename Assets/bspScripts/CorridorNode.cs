...
public class CorridorNode : Node
{
    ...
    private void ProcessRoomInRelationUpOrDown(Node structure1, Node structure2)
    {
        ...
        List<Node> structureAboveChilderen = StructureHelper.TraverseGraphToExtractLowestLeafes(structure2);
        ...
        var possibleNeighboursInTopStructure = structureAboveChilderen.Where(child => GetValidXforNeighbourUpDown(
